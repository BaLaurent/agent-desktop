 ...
 *
 * Ported from src/main/services/sessionManager/buildQueryOptions.ts — Electron-free;
 * only the findBinaryInPath import moved to its canonical core module (../../../core/utils/env).
 *
