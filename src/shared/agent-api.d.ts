...
import type { PIExtensionInfo } from './constants'
import type { PiUIEvent, PiUIRequest, PiUIResponse } from './piUITypes'
import type { GitStatus, GitCommit, GitCommitFile, GitBranch, GitStashEntry } from './git-types'
...
export interface AgentAPI {
  ...
  system: {
    ...
    importDroppedFile(name: string, bytes: Uint8Array): Promise<string>
